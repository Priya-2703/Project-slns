      ...
      <div className="max-w-7xl mx-auto px-4 py-3 md:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <motion.div variants={sidebarVariants} className="lg:col-span-1">
            <div className="bg-black rounded-[20px] lg:p-6 p-3 border border-gray-900 sticky top-6">
              <motion.div
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.5, delay: 0.2 }}
                className="flex lg:flex-col items-center mb-6 gap-3 ml-6 lg:ml-0"
              >
                <motion.img
                  ...
                  loading="lazy"
                  alt="Profile"
                  className="md:w-24 md:h-24 w-10 h-10 rounded-full border-4 border-white/10 md:mb-3"
                />
                <div className="flex flex-col justify-center items-start md:items-center">
                  <h3 className="text-[12px] md:text-[18px] capitalize font-body font-medium">
                    {userData.name}
                  </h3>
                  <p className="text-gray-400 font-body text-[8px] md:text-[12px]">
                    {userData.email}
                  </p>
                </div>
              </motion.div>

              <nav className="lg:space-y-2 flex lg:flex-col justify-around items-center">
                {[
                  ...
                  <motion.button
                    ...
                    className={`lg:w-full flex items-center gap-3 p-2 md:px-4 md:py-3 font-body font-extrabold text-[16px] rounded-[50px] transition-all duration-300 ${
                      activeTab === item.id
                        ? "bg-white text-black font-black"
                        : "text-gray-400 hover:bg-gray-800 hover:text-white"
                    }`}
                  >
                    <item.icon size={mobileView ? 22 : 20} />
