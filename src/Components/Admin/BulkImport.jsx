    ...
    <div className="min-h-screen bg-black py-20 mt-14">
      <div className="w-[90%] max-w-4xl mx-auto">
        ...
        <div className="mb-10">
          <Link
            to="/admin/dashboard"
            className="text-white hover:text-white/60 font-body inline-block bg-white/10 hover:bg-black cursor-pointer border border-white/30 rounded-4xl py-2 px-4 duration-300 transition-all my-2"
          >
          ...
          <p className="text-white/60 font2 mt-2">
        ...
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-6 mb-8">
          <h2 className="text-xl font-bold text-blue-400 font1 mb-4">
            📋 Instructions
          </h2>
          <ol className="space-y-2 text-white/80 font2 list-decimal list-inside">
            ...
            <li>
              Make sure category names match exactly with existing categories
            </li>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-6 mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-white/60 font2">
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-8 mb-8">
          <h3 className="text-xl font-bold text-white font1 mb-6">
            Upload File
          </h3>
          ...
          >
            ...
            {file ? (
              ...
              <div>
                <p className="text-white font2 text-lg mb-2">
                  Click to upload file
                </p>
                <p className="text-white/40 font2 text-sm">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                <div className="flex items-center justify-between">
                  <span className="text-green-400 font2">
            ...
            {result.errors && result.errors.length > 0 && (
              <div>
                <h4 className="text-lg font-bold text-white font2 mb-3">
                  Errors:
                </h4>
                <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4 max-h-60 overflow-y-auto">
                  {result.errors.map((error, index) => (
                    <div
                      key={index}
                      className="text-red-400 font2 text-sm mb-2"
                    >
                      • {error}
                    </div>
                  ))}
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-6 mt-8">
          <h3 className="text-xl font-bold text-white font1 mb-4">
            CSV Format Guide
          </h3>
